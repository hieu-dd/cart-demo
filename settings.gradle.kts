...
project(":cart:cart-core").projectDir =
    File(rootProject.projectDir, "./cart/cart-core")

project(":cart:cart-bus").projectDir =
    File(rootProject.projectDir, "./cart/cart-bus")

project(":cart:cart-ui").projectDir =
    File(rootProject.projectDir, "./cart/cart-ui")
